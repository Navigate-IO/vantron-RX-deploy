...
echo "============================================"
echo " Vantron MCS Matrix RX — Full Setup"
echo "============================================"
...
sudo cp "$SCRIPT_DIR/mcs-matrix-rx.service" /etc/systemd/system/
sudo cp "$SCRIPT_DIR/drone-server.service" /etc/systemd/system/

sudo systemctl daemon-reload
sudo systemctl enable mcs-matrix-rx.service
...
sudo systemctl start mcs-matrix-rx
